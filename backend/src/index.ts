...
import { handleGetInvestments as handleAdminGetInvestments, handleUpdateInvestment } from './routes/admin/investments';
...
const routes: Route[] = [
  ...
  { method: 'GET', pattern: /^\/admin\/investments$/, handler: handleAdminGetInvestments },
