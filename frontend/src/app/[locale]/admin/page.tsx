  ...
  return (
    <div className="p-4 md:p-8 pt-16 md:pt-8">
      <div className="mb-8">
        ...
        <p className="text-gray-light">{t('dashboard')}</p>
      </div>

      {/* Stats Cards */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <LocaleLink href="/admin/users" className="bg-blur-dark border border-gray-medium rounded-lg p-6 hover:border-silver/30 transition-all cursor-pointer">
          <div className="text-sm text-gray-light mb-2">{t('totalUsers')}</div>
          <div className="text-3xl font-bold text-foreground font-sans">{stats.totalUsers}</div>
        </LocaleLink>

        <LocaleLink href="/admin/deposits" className="bg-blur-dark border border-gray-medium rounded-lg p-6 hover:border-silver/30 transition-all cursor-pointer">
          <div className="text-sm text-gray-light mb-2">{t('pendingDeposits')}</div>
          <div className="text-3xl font-bold text-yellow-500 font-sans">{stats.pendingDeposits}</div>
        </LocaleLink>

        <LocaleLink href="/admin/withdrawals" className="bg-blur-dark border border-gray-medium rounded-lg p-6 hover:border-silver/30 transition-all cursor-pointer">
          <div className="text-sm text-gray-light mb-2">{t('pendingWithdrawals')}</div>
          <div className="text-3xl font-bold text-yellow-500 font-sans">{stats.pendingWithdrawals}</div>
        </LocaleLink>

        <LocaleLink href="/admin/payment-methods" className="bg-blur-dark border border-gray-medium rounded-lg p-6 hover:border-silver/30 transition-all cursor-pointer">
          <div className="text-sm text-gray-light mb-2">{t('activePaymentMethods')}</div>
          <div className="text-3xl font-bold text-silver font-sans">{stats.activePaymentMethods}</div>
        </LocaleLink>

        <LocaleLink href="/admin/investments" className="bg-blur-dark border border-gray-medium rounded-lg p-6 hover:border-silver/30 transition-all cursor-pointer">
          <div className="text-sm text-gray-light mb-2">{t('totalInvestments')}</div>
          <div className="text-3xl font-bold text-foreground font-sans">{stats.totalInvestments}</div>
        </LocaleLink>

        <LocaleLink href="/admin/investments" className="bg-blur-dark border border-gray-medium rounded-lg p-6 hover:border-silver/30 transition-all cursor-pointer">
          <div className="text-sm text-gray-light mb-2">{t('currentBalances')}</div>
          <div className="text-3xl font-bold text-silver font-sans">${stats.currentBalances.toFixed(2)}</div>
        </LocaleLink>

        <LocaleLink href="/admin/investments" className="bg-blur-dark border border-gray-medium rounded-lg p-6 hover:border-silver/30 transition-all cursor-pointer">
          <div className="text-sm text-gray-light mb-2">{t('totalInvested')}</div>
          <div className="text-3xl font-bold text-foreground font-sans">${stats.totalInvested.toFixed(2)}</div>
        </LocaleLink>

        <LocaleLink href="/admin/investments" className="bg-blur-dark border border-gray-medium rounded-lg p-6 hover:border-silver/30 transition-all cursor-pointer">
          <div className="text-sm text-gray-light mb-2">{t('totalEarned')}</div>
          <div className="text-3xl font-bold text-green-400 font-sans">+${stats.totalEarned.toFixed(2)}</div>
        </LocaleLink>

        <LocaleLink href="/admin/withdrawals" className="bg-blur-dark border border-gray-medium rounded-lg p-6 hover:border-silver/30 transition-all cursor-pointer">
          <div className="text-sm text-gray-light mb-2">{t('lockedFunds')}</div>
          <div className="text-3xl font-bold text-orange-400 font-sans">${stats.lockedFunds.toFixed(2)}</div>
        </LocaleLink>

        <LocaleLink href="/admin/withdrawals" className="bg-blur-dark border border-gray-medium rounded-lg p-6 hover:border-silver/30 transition-all cursor-pointer">
          <div className="text-sm text-gray-light mb-2">{t('totalWithdrawn')}</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          >
            ...
            <div>
              ...
              <div className="text-xs text-gray-light">{t('viewManage')}</div>
            </div>
          </LocaleLink>
          ...
          >
            ...
            <div>
              ...
              <div className="text-xs text-gray-light">{t('manageWallets')}</div>
            </div>
          </LocaleLink>
          ...
          >
            ...
            <div>
              <div className="font-medium">{t('deposits')}</div>
              <div className="text-xs text-gray-light">{t('viewManage')}</div>
            </div>
          </LocaleLink>
          ...
          >
            ...
            <div>
              <div className="font-medium">{t('withdrawals')}</div>
              <div className="text-xs text-gray-light">{t('manageWithdrawals')}</div>
            </div>
          </LocaleLink>
          ...
          >
            <div className="text-silver"><WalletIcon /></div>
            <div>
              <div className="font-medium">{t('investments')}</div>
              <div className="text-xs text-gray-light">{t('viewManage')}</div>
            </div>
          </LocaleLink>
